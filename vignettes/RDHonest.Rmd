...
paramter space under which this method yields honest inference.
...
<!-- export(EqKern) --> <!-- export(IKBW.fit) --> <!-- export(KernMoment) -->
<!-- export(RDLPreg) --> <!-- export(RDPrelimVar) --> <!--
export(RDTEfficiencyBound) --> <!-- export(RDTOpt.fit) -->
