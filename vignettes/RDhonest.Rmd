...
# Inference in Local polynomial regression
...
## Discrete running variable TODO
...
intervals, as described in Section 2.2 in @ArKo16optimal.
...
For Taylor smoothness class, instead of using local polynomial estimators, one
can use estimators with optimally chosen weights. This typically yields tighter
CIs. Comparing the lenghts of two-sided CIs with optimally chosen bandwidths:
